      ...
      <div className="container relative grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7">
          ...
          >
            ...
            <motion.a 
              href="tel:+919999502399"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <Button size="lg" variant="outline" className="rounded-full border-border/60 hover:bg-accent/10 hover:text-accent hover:border-accent/50 transition-colors">
