        ...
        <div className="flex-1 grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 auto-rows-fr gap-4">
          {tiles.map((tile, i) => (
            <motion.button
              ...
              className="group rounded-2xl border border-border/50 bg-card/50 shadow-sm backdrop-blur-xl flex flex-col items-center justify-center gap-3 p-4 transition-all hover:-translate-y-1 hover:shadow-lg hover:border-accent/50"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary text-foreground/70 transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
